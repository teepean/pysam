...
# NB: we force openblas for bcftools-with-GSL due to conda/conda#7548
conda install -y "samtools=1.10" "bcftools=1.10.2" "htslib=1.10.2" xz curl bzip2 conda-forge:ncurses conda-forge::blas=*=openblas
